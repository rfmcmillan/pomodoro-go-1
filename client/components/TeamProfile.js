    ...
    <div id="profile-group">
      ...
      <AvatarGroup max={5} id="avatars">
        <Avatar
          ...
          className={
            expanded.russel === true ? classes.largeClicked : classes.large
          }
          onClick={toggle}
        />
        <Avatar
          ...
          className={
            expanded.ding === true ? classes.largeClicked : classes.large
          }
          onClick={toggle}
        />
        <Avatar
          ...
          className={
            expanded.stephan === true ? classes.largeClicked : classes.large
          }
          onClick={toggle}
        />
        <Avatar
          ...
          className={
            expanded.felicity === true ? classes.largeClicked : classes.large
          }
          onClick={toggle}
        />
      </AvatarGroup>
